      ...
      <div className="main" id="contact">
        ...
        <div className="row">
          ...
          <div className="image-content-profile">
            ...
            <img src="https://avatars.githubusercontent.com/u/20920564?v=4" alt={prof.name} className="profile-image" />
          </div>
        </div>
      </div>
    </Fade>
